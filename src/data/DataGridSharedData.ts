import { hyperlinkIntent } from "igniteui-core";
...
export class DataGridSharedData {
    public static getEmployees(count?: number): any[] {
        ...
        // return [
        //     { ID: null, Name: null, Age: 30, Birthday: this.getBirthday(30), Country: "USA", Position: null, Children: undefined, URL: "https://www.google.com", display: "Google" },
        //     { ID: 2, Name: null, Age: 25, Birthday: this.getBirthday(30), Country: "UK", Position: null, Children: undefined, URL: "https://www.google.com" },
        //     { ID: 3, Name: "Sam Brown", Age: 28, Birthday: this.getBirthday(30), Country: "Canada", Position: null, Children: undefined, URL: "https://www.google.com" },
        //     { ID: null, Name: "Lisa White", Age: 32, Birthday: this.getBirthday(30), Country: "Australia", Position: "Analyst", Children: undefined, URL: "https://www.google.com" },
        //     { ID: 5, Name: "Tom Green", Age: 29, Birthday: this.getBirthday(30), Country: "Germany", Position: "Tester", Children: [ { name: "tom", value: new Date(Date.now()) }], URL: "https://www.google.com" }
        // ];
        if (count === undefined) {
            count = 10;
        }
        ...
        for (let i = 0; i < count; i++) {
            ...
            const email: string = "mailto:" +firstName.toLowerCase() + "@" + this.getRandomItem(this.emails);
            ...
            person.Email = i > 2 ? email : null;//"https://www.google.com";
    ...
    private static femaleNames: string[] = [
        "Gina",
        "Irene",
        "Katie",
        "Brenda",
